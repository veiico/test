...
@Component({
    selector: 'app-often-bought',
    templateUrl: './often-bought.component.html',
    styleUrls: ['./often-bought.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: [slideUpDownDOM]
})
export class OftenBoughtComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public product_layout_type: number = 2;
    ...
    */
    ...
    getProducts(data) {
        ...
        cartData.forEach(element => {
            if (element.often_bought_products.length > 0) {
        ...
        if (this.oftenBoughtArray.length > 0) {
            data.product_ids_array = this.oftenBoughtArray;
        }
