...
@Component({
  selector: 'app-vista-add-card',
  templateUrl: './add-card.component.html',
  styleUrls: ['./add-card.component.scss']
})
export class VistaAddCardComponent implements OnInit, AfterViewInit, OnDestroy {

  languageStrings: any={};
  public config: any;
  public terminology: any;
  public vistaLink: any;
  public langJson: any;
  public languageSelected: string;
  public direction: string;
  public card: any;
  public showVistaAddCard: boolean;
  ...
  constructor(protected sessionService: SessionService,
              ...
              protected vistaService: VistaService,
 ...
 addCard() {
  ...
  this.vistaLink = this.domSanitizer.bypassSecurityTrustResourceUrl(this.addCardLink += "&domain_name=" + encodeURIComponent(window.location.origin));
  this.showVistaAddCard = true;
 }
